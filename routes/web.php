...
Route::get('/class-show/{id}', [ClassController::class, 'show'])->middleware('auth')->name('class-show/{id}');
...
Route::get('/marksheet/{class_id}', [MarksController::class, 'create'])->middleware(['auth', 'checkPeriod'])->name('marks');
