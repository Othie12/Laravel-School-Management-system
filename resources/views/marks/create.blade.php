...
<div class="tabbable tabs-left">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tab{{ $subject->id }}">
            ...
            <form method="POST" action="{{ route('marks.resolve-storage') }}">
                @csrf
        ...
        <table class="table table-hover table-striped" >
            ...
            <tbody>
                ...
                <tr>
                    <td> <img src="{{ asset('storage/' . $student->profile_pic_filepath) }}" alt="Profile Image" width="30" class="rounded-md mr-2"> {{ $student->name }}</td>
