...
<section>
    ...
    <form method="post" action="{{ Auth::user()->id === $user->id ? route('profile.update') : route('profile.updateOther'); }}" class="mt-6 space-y-6">
        @csrf
        @method('patch')
        ...
        <div class="mt-4">
            ...
            <x-text-input id="contact" type="tel" name="contact" :value="old('contact', $user->contact)" />
        </div>
        ...
        <div>
            ...
            <!-- Role: can only be set by admini -->
